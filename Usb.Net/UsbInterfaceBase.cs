    ...
    public abstract class UsbInterfaceBase
    {
        ...
        public IUsbInterfaceEndpoint ReadEndpoint
        {
            get
            {
                ...
                {
                    _ReadEndpoint = UsbInterfaceEndpoints.FirstOrDefault(p => p.IsRead && !p.IsInterrupt);
                }
...
#pragma warning restore CA1062 // Validate arguments of public methods
        ...
        public IUsbInterfaceEndpoint WriteEndpoint
        {
            get
            {
                ...
                {
                    _WriteEndpoint = UsbInterfaceEndpoints.FirstOrDefault(p => p.IsWrite && !p.IsInterrupt);
                }
...
#pragma warning restore CA1062 // Validate arguments of public methods
        ...
        public IUsbInterfaceEndpoint InterruptWriteEndpoint
        {
            get
            {
                if (_WriteInterruptEndpoint == null)
                {
                    _WriteInterruptEndpoint = UsbInterfaceEndpoints.FirstOrDefault(p => p.IsInterrupt && p.IsWrite);
                }
                return _WriteEndpoint;
            }
            set
        ...
        public IUsbInterfaceEndpoint InterruptReadEndpoint
        {
            get
            {
                if (_ReadInterruptEndpoint == null)
                {
                    _ReadInterruptEndpoint = UsbInterfaceEndpoints.FirstOrDefault(p => p.IsInterrupt && p.IsRead);
                }
                return _WriteEndpoint;
            }
            set
